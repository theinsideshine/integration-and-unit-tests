package com.theinsideshine.test.springboot.app.springboot_test.controllers;
...
import com.theinsideshine.test.springboot.app.springboot_test.models.TransaccionDto;
...
class CuentaControllerTest {
    ...
    void testDetalle() throws Exception {
        ...
        mvc.perform(get("/api/cuentas/1").contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(content().contentType(MediaType.APPLICATION_JSON)) //se chequea el contenType
    ...
    void testTransferir() throws Exception, JsonProcessingException {
        ...
        mvc.perform(post("/api/cuentas/transferir")
                ...
                // Hasta se prueban los campos que yo quiero, a continuacion se prueba el response completo
